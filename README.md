...
- tested on RHEL, Ubuntu, CentOs, Almalinux (Docker),among others.  
...
## Includes
This code, when ./install is ran, adds the following to whatever user you bashetize..
...
2. The other way is you can run the install.sh script to copy files into your user directory. 
